...
## Instructions
Setup the windows hotspot first, just simply go to the hotspot settings, and configure the SSID/Password. Make sure to set the band to 5ghz, or you'll have a pretty crappy time.
